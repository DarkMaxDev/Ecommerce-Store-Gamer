...
const stripePromise = loadStripe(
	"pk_test_51Qtx7cGgooLbj1cYmjUOLKggucV9HrKx26nwLHUeMKEcq3IJ0oDxeUWjIHy6XUTBRXYF4smNPRAEo0M76EOyy2TD00Qfg11hXq"
);
	...
	return (
		...
		>
			...
			<div className='space-y-4'>
				...
				<motion.button
					className='flex w-full items-center justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-emerald-300'
